...
import com.ckc.pushnotificationhttps.ui.theme.PushNotificationHttpsTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requesNotificationPermissions()
        setContent {
            PushNotificationHttpsTheme {
                Surface (
    ...
    private fun requesNotificationPermissions() {
